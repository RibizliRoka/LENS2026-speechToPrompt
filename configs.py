...
class RobotClientConfig:
    ...
    task_file: str | None = field(default=None, metadata={"help": "Filepath to task instruction"})

    # Network configuration
    server_address: str = field(default="localhost:8080", metadata={"help": "Server address to connect to"})

    # Boolean for speech to Text
    speechToText: bool = field(default = False, metadata = {"help":"Turns on text to speech feature or not. False for no speech to text"})
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "speechToText":self.speechToText,
        }
