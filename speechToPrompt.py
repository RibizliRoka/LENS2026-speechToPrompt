...
@parser.wrap()
def record(ourModifiedString: str, cfg: RecordConfig) -> LeRobotDataset:
    init_logging()
        ...
        with VideoEncodingManager(dataset):
            ...
            while recorded_episodes < cfg.dataset.num_episodes and not events["stop_recording"]:
                ...
                record_loop(
                    ...
                    single_task= ourModifiedString, #cfg.dataset.single_task,
                ...
                if not events["stop_recording"] and (
                    ...
                    record_loop(
                        ...
                        single_task= oourModifiedString, #cfg.dataset.single_task,
                        display_data=cfg.display_data,
                    )
